...
const MadeEasy = ()=> {
    ...
    return (
        ...
        <OwlCarousel className={`${style.carousel} owl-theme`}
        items="3"
        dots
        responsive={{
            0: {
        ...
        <div className={style.pic}>
            ...
            <p className={`${style.sub_par}`}>Choose from millions of spaces across Egypt</p>
            <p className={`${style.sub_par}`}>Find your best option for every car journey</p>
            </div>
        ...
        <div className={`${style.carousel_item} item`}>
            ...
            <p className={`${style.sub_par}`}>View information on availability, price and restrictions</p>
            <p className={`${style.sub_par}`}>Reserve in advance at over 45,000+ locations</p>
            </div>
        </div>
        <div className={`${style.carousel_item} item`}>
        <div className={style.pic}>
            ...
            <p className={`${style.sub_par}`}>Pay for IPark spaces via the app or website</p>
            <p className={`${style.sub_par}`}>Follow easy directions and access instructions</p>
            </div>
        </div>
      </OwlCarousel>
        </section>
